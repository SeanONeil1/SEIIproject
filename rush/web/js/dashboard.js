...
function setLeftButtonToShowPersonalForms() {
	$("#leftListButton").text("Create New Form");
	$("#leftListButton").show();
...
function addFunctionToTabs() {
	$("#therapiesTab").click(function() {
		...
		$("#patientFilters").addClass("hideFilters");
	});
    ...
    $("#patientsTab").click(function(){
			...
			$("#therapyFilters").addClass("hideFilters");
			$("#userFilters").addClass("hideFilters");
			$("#patientFilters").removeClass("hideFilters");
        	$('#contentHolder').children().hide();
        	$('#patientForm').show()
    });
...
function setEditPatientFunctionality() {
	
	$("a.editPatientLink").each(function() {
		$(this).click(function() {
			var patientId = $(this).parent().next().text();
